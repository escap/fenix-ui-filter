define([
    ...
    FC.prototype.add = function (modules_array, adapter_map) {
        ...
        if (Array.isArray(modules_array)) {
            ...
            for (var i = 0; i < modules_array.length; i++) {
                ...
                var element = modules_array[i],
                    options = {
                    "mainContent": this.options.mainContent,
                    "MAIN_CONTAINER": this.options.html_ids.MAIN_CONTAINER,
                    "module_id": this.options.module_id,
                    "container_plugin_dir": this.options.container_plugin_dir,
                    "component_plugin_dir": this.options.component_plugin_dir
                };
...
//                            var component = this.options.filter_module_array[i].options.component;
    ...
    FC.prototype.layoutRender = function () {
        ...
        this.options.layout_render.render({
            "mainContent": this.options.mainContent,
            "MAIN_CONTAINER": this.options.html_ids.MAIN_CONTAINER,
            "ITEM_COMPONENT_CLASS_ID": this.options.class_ids.ITEM_COMPONENT
        });
    }
